  ...
  return (
    <>
      <div className="flex flex-col  md:flex-row ">
        <div className="flex-1 bg-background-back0 border rounded-md p-4">
        ...
        <div className="w-full md:w-1/4 md:ml-8 sx:ml-0 border rounded-md md:mt-0 mt-4 sm:ml-0 p-4 bg-background-back1">
          <div className="px-4">
