			...
			<div className="w-full max-w-sm bg-white border border-gray-300 rounded-lg shadow-pink100 hover:shadow-pink400">
				...
				<div className="px-4 pb-3 pt-2">
					...
					<div className="flex items-center mt-2.5 mb-3">
						...
						<span className="bg-fta-accent1 text-primary-300 text-xs font-semibold px-2.5 py-0.5 rounded ms-3">5.0</span>
					...
					<div className="flex items-center justify-between text-[14px] md:text-md">
						<span className="text-md md:text-xl font-bold text-primary-500">${product.price}</span>
						<Link href={`/product/${product.ID}`}>
							<button className="text-white bg-primary-500 hover:bg-primary-500 focus:ring-4 focus:outline-none font-medium rounded-lg px-2 md:px-5 py-1 md:py-2.5 text-center">
								Add to cart
							</button>
						</Link>
					</div>
