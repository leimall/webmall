...
const AddressForm: React.FC<AddressFormProps> = ({ mode, title, onSubmit, values }) => {
        ...
        if (data.length > 0) {
          ...
          components.forEach((component: any) => {
            ...
            if (types.includes("country")) {
              ...
              addressParts.countryName = component.short_name;
            }
          ...
          // 更新表单值
          setValue("firstName", addressParts.firstName);
          setValue("lastName", addressParts.lastName);
          setValue("email", addressParts.email);
          setValue("phone", addressParts.phone);
  ...
  useEffect(() => {
    console.error("113142423423432", values);
  }, [values])
        ...
        <div className="grid md:grid-cols-2 gap-2">
          ...
          >
            <Controller
              name="city"
              control={control}
              render={({ field }) => <Input id="City" label="Street Address" {...field} />}
            />
          </Form.Item>
