    ...
    <div>
      <div className="font-[sans-serif] p-4">
        <div className="mx-auto">
          ...
          <div className="grid md:grid-cols-6 sm:grid-cols-2 gap-8 max-sm:justify-center text-center mt-12">
            ...
            <div className="bg-gray-200 max-w-[230px] rounded-tl-full rounded-tr-full">
              ...
              <div className="p-4">
                ...
                <span className="text-gray-600 text-xs mt-1">Software Engineer</span>
                <p className="mt-4 text-gray-600 text-sm">Eiusmod commodo aliquip laboris qui anim non voluptate consectetur.</p>
            ...
            <div className="bg-gray-200 max-w-[230px] rounded-tl-full rounded-tr-full">
              <img src="https://readymadeui.com/team-2.webp" className="rounded-full" />
